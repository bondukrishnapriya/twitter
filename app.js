...
const tweetAccessVerification = async (request, response, next) => {
  ...
  INNER JOIN follower ON tweet.user_id =follower.following_user_id WHERE 
...
app.get('/user/followers', authentication, async (request, response) => {
  ...
  const getFollowersQuery = `SELECT DISTINCT name FROM follower INNER JOIN user 
  ON user.user_id =follower.follwer_user_id WHERE following_user_id =${userId};`
...
app.get('/users/tweets/', authentication, async (request, response) => {
  ...
  SELECT tweet , COUNT(DISTINCT like_id) AS likes, COUNT(DISTINCT reply_id) AS replies, 
  date_time AS dateTime FROM tweet LEFT JOIN reply ON tweet.tweet_id =reply.tweet_id LEFT JOIN like On tweet.tweet_id=like.tweet_id WHERE  tweet.user_id=${userId} 
